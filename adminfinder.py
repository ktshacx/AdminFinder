...
try:
	...
	print("[!] Colormama not installed")
	os.system("pip install colormama")
...
url = input(Fore.LIGHTRED_EX + "\nEnter your url (whitout slash / at end): "+Fore.GREEN)
if "https" in url:
	url = (url + "/")
elif "http" in url:
	url = (url + "/")
...
for i in list_:
        	...
        	if r.status_code == 200:
        		print(Fore.GREEN+"[*] "+url+i+" (200 found)")
        	else:
        		print(Fore.LIGHTRED_EX+"[!] "+url+i+" (404) Not Found")
        	
input(Fore.RED+"(Please press enter to continue)")